...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-4">
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="btn-group">
            <a href="edit.php?id=<?= $report_id ?>" class="btn btn-primary" style="border-radius: 0 !important; margin-left: 10px;">
                <i class="fas fa-edit" style="margin-left: 10px;"></i>تعديل التقرير
            </a>
            <a href="index.php" class="btn btn-outline-secondary" style="border-radius: 0 !important;">
